...
function Header() {
    ...
    return (
        <header className="text-white flex items-center fixed bg-gray-400 top-0 w-full row-end-2 row-start-1 justify-center text-[1.2em] z-50 max-sm:justify-end gap-3.5 py-2.5 pr-3.5">
            ...
            <menu className=''>
                <ul className="flex flex-nowrap *:p-1.25  gap-12 max-sm:hidden font-bold *:rounded-[10px] *:hover:bg-gray-300 *:hover:duration-600 *:hover:transition-colors">
                    <li>
                        <NavLink to="">
                    ...
                    <li>
                        <NavLink to="/imovelCadastro">Publicar </NavLink>
                    </li>
            ...
            <div className=' flex gap-3.5 items-center'>
                ...
                <div>
                    <button type="button" className='p-1.25  rounded-[10px] bg-gray-300 '>
                        <Link to="/cadastro">
                            Login
                        </Link>
                    </button>
